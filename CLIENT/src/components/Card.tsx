...
function JamerCard({ jemerDataLocal, jemerCardId }: { jemerDataLocal: any, jemerCardId: any }) {
 ...
 const [musicGener, setMusicGener] = useState(capFirtsLett(jemerDataLocal?.musicalGaners[0]))
 const [instruments, setInstruments] = useState(capFirtsLett(jemerDataLocal?.musicalInstruments[0]))
 const [obout, setObout] = useState(jemerDataLocal?.oboutMe)
 const [references, setReferences] = useState(capFirtsLett(jemerDataLocal?.references))
...
const saveProfile = async() =>{
  ...
  const payload = {
    ...
    oboutMe: obout,
      ...
      const data = await dataAxios.userCardDataUpdate(globalUserId, payload)
      setCurrentMode("")
...
useEffect(() =>  {
  ...
  return (<>
            <Card sx={{ minWidth: 275 }}>
                ...
                <Box sx={{ flexGrow: 1 }}>
                  <Grid container spacing={2}>
                    ...
                    <div>
                      ...
                      <Input className="inputCard" onChange={handleNickNameChange} value={nickName} />
                    </div>

                      <div className="itemConected"> 
                      <span className="secTex"> Full Name: </span>  
                      <Input className="inputCard" onChange={handleFullNameChange} value={fullName} /> 
                      ...
                      <Input className="inputCard" onChange={handleLocationChange} value={location}
                      />
                      </div>
                    ...
                    <Grid item xs={4}>
                      ...
                      <Input className="inputCard"  onChange={handleAgeChange} value={age} />
                      </div>

                      <div className="itemConected">
                      <span className="secTex">Gender: </span>
                      <Input className="inputCard" onChange={handleGenderChange} value={gener} />
                      </div>
                    ...
                    <Grid item xs={6}>
                      ...
                      <Input className="inputCard" onChange={handleMusicGenerChange}  value={musicGener} />{" "}
                      </div>
                    </Grid>
                    ...
                    <Grid item xs={6}>
                      ...
                      <Input className="inputCard" onChange={handleInstrumentsChange} value={instruments} />{" "}
                      </div>
                    </Grid>
                    ...
                    <Grid item xs={8}>
                      ...
                      <br></br><br></br>
                      <Input className="inputCard" onChange={handleOboutChange} value={obout} />
                      </div>
                    </Grid>
                    ...
                    <Grid item xs={4}>
                      ...
                      <br></br><br></br> 
                      <Input className="inputCard" onChange={handleReferencesChange} value={references} />
                      </div>
                    </Grid>
              ...
              <Box sx={{ flexGrow: 1 }}>
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={4}>
                    ...
                    <Item > 
                    <span className="secTex">I'm from:
                    </span> {location} {jemerDataLocal?.country}
                    </Item>
                  ...
                  <Grid item xs={6}>
                    <Item> 
                      <span className="secTex"> Music Geners: </span>{musicGener}{" "}
                    </Item>
                  </Grid>
              ...
              <CardActions>
                {currentMode != "Edit Mode" ?<Button size="small" onClick={editProfile}>Edit Profile</Button>: null}
